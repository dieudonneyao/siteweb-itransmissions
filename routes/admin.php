...
Route::get('dashboard/categorie', [CategorieController::class, 'admin_cat']);
...
Route::get('dashboard/sous-categorie', [Sous_CategorieController::class, 'index'])->name('scat');
...
Route::get('dashboard/products', [ProduitController::class, 'index'])->name('products');
Route::get('dashboard/products/{id}', [ProduitController::class, 'show'])->name('products_edits');
...
Route::get('dashboard/itransmissions_users',[UserController::class, 'index'])->name('user.index');
Route::get('dashboard/itransmissions_users/create',[UserController::class, 'create'])->name('user.create');
Route::post('dashboard/itransmissions_users',[UserController::class, 'store_user'])->name('user.store');
Route::get('dashboard/itransmissions_users/{id}/edit',[UserController::class, 'edit'])->name('user.edit');
Route::put('dashboard/itransmissions_users/{id}/update',[UserController::class, 'update'])->name('user.update');
Route::delete('dashboard/itransmissions_users/{id}/delete',[UserController::class, 'destroy'])->name('user.delete');
