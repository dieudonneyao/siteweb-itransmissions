                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Vente et distribution de picèces</h3>
                                    <div class="text">
                                        <p>Nous sommes les représentant de plusieurs marques de renom qui nous permettent de mettre à la disposition de nos clients, des 
                                            pièces de qualités et variées.</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="blog.html">En savoir plus<span class="flaticon-next"></span></a>
                                    </div>
                        ...
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Négoce</h3>
                                    <div class="text">
                                        <p>i-transmission est un pole d'acquisition de toute sorte de matériels, plusieurs fournisseurs nous font confiance
                                            et nos clients sont toujours satisfaits.</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="blog.html">En savoir plus<span class="flaticon-next"></span></a>
                                    </div>
