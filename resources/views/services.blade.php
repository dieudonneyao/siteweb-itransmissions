    ...
    <section class="breadcrumb-area style2" style="background-image: url(images/resources/banner.jpg);">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5">
                        <div class="sec-title">
                            <p>Services</p>
                            <div class="title">Domaine <span> d'activités</span></div>
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="text">
                            <p>Nous sommes des représentants de marques at assurons la distribution et la vente de pièces de transmission industrielles et automobiles.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Transmissions Industrielles</h3>
                                    <div class="text">
                                        <p>Nous sommes les représentant de plusieurs marques de renom qui nous permettent de mettre à la disposition de nos clients, des 
                                            pièces de transmissions industrielles de qualités et variées.</p>
                                    </div>
                                    <div class="read-more">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Quincaillérie Industrielle</h3>
                                    <div class="text">
                                        <p>i-transmission est aussi une importante société qui met à votre disposition une large et diversifié
                        ...
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Négoce</h3>
                                    <div class="text">
                                        <p>Vous voulez un produit ? Vous désirez échanger avec des professionnles ? Et surtout 
                                            vous exigez la qualité ? i-transmission est votre meilleur atout.
                                        </p>
                                    </div>
                                    <div class="read-more">
                        ...
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    <h3>Electricité</h3>
                                    <div class="text">
                                        <p>Avec notre réseau de partenaire dans le monde entier, nous sommes aussi un pole de distribution et 
                                            de vente de matériels électrique.</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="#">En savoir plus<span class="flaticon-next"></span></a>
                                    </div>
                        ...
                        <div class="single-service-style2 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="text">
                                        <p>Nous assurons la formation sur l'utilisation des pièces que nous fournissons, par des experts 
                                            qui vous aiderons par leurs conseils à mieux tirer profit de vos équipements.</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="btn-one" href="#">En savoir plus<span class="flaticon-next"></span></a>
                                    </div>
        ...
        <section class="services-style1-service-page">
            <div class="container">
                <div class="sec-title text-center wow fadeInDown" data-wow-delay="100ms" data-wow-duration="1200ms">
                    <p>Bon coup de la semaine</p>
                    <div class="title">Nos meilleures <span>Ventes</span></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-service-style1 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1200ms">
                            <div class="img-holder">
                                <img src="images/services/7.jpg" alt="Awesome Image">
                                <div class="overlay-style-two"></div>
                            </div>
                            <div class="text-holder bg-white">
                                <div class="inner-content">
                                ...
                                <div class="overlay-content">
                                    <div class="text">
                                        <p> Ce n'est pas une surprises si ces petits si importants sont parmi les meilleures ventes. Indispensable pour les raccordement et les fixations, ils sont beaucoup utilisés</p>
                                    </div>
                                    <div class="read-more">
                                        <a href="#"><span class="icon-next"></span></a>
                                    </div>
        ...
        <section class="testimonial-style3-service-page">
            <div class="container">
                <div class="sec-title">
                    <p>Témoignage</p>
                    <div class="title">Les mots de nos <span>Clients</span></div>
                </div>
                <div class="row">
                        ...
                        <div class="testimonial-carousel-2 owl-carousel owl-theme">
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    ...
                                    <div class="text-box">
                                        <p>"i-transmission à toujours eu cette capacité de répondre à mes besoins en termes de pièces de transmission industrielle et ceux dans un délai récord”.</p>
                                    </div>
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="images/testimonial/testi-style3-3.png" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                            <h3>Hervé Jacquet</h3>
                                            <span>Abidjan Yopougon</span>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        <p>“les services proposés par la société i-transmission sont impéccable et il faut aussi parler de la qualité de leur produit qui sont le fruit d'une collaboration fructueuse avec des grandes marques”.</p>
                                    </div>
                                    <div class="review-box">
                                        <ul>
                                            <li><i class="fa fa-star"></i></li>
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        ...
                                        <div class="title">
                                            <h3>Jean Phillipe Ettien</h3>
                                            <span>Cocody</span>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        <p>"Moi j'ai été émerveillé par le Service Après Vente de la société i-transmission qui a su me donner satisfaction quand j'avais un problème avec une pièce”.</p>
                                    </div>
                                    <div class="review-box">
                                        <ul>
                                            <li><i class="fa fa-star"></i></li>
