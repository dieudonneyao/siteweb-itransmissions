...
<section class="main-slider">
    ...
    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <h4>Distribution / vente</h4>
                                    <p>Transmissions Industrielle et automobile.</p>
                                </div>
                                <a class="btn-one" href="/product">En savoir plus<span class="flaticon-next"></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <h4>Quincaillérie et Négoce</h4>
                                    <p>Industrielle et divers produits à la demande.</p>
                                </div>
                                <a class="btn-one" href="/product">En savoir plus<span class="flaticon-next"></span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <h4>Services Après-vente</h4>
                                    <p>Disponible pour vos reclamations et soutien</p>
                                </div>
                                <a class="btn-one" href="/services">En savoir plus<span class="flaticon-next"></span></a>
                            </div>
                        </div>
                    </div>
                    <!--End single highlight box-->
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5">
                        <div class="about-image-box">
                            ...
                            <div class="text-box">
                                <p>I-TRANSMISSIONS a été créée en JUIN 2020.</p>
                                <h3>M. Adjiri Séraphin, <span>CEO & Fondateur</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-7">
                        <div class="about-text">
                            <div class="sec-title">
                                <p>Notre société</p>
                                <div class="title">Diversifier<br> Accroître <span>sa clientèle</span></div>
                            </div>
                            <div class="inner-content">
                                <div class="text">
                                    <p>Une équipe de personnel compétente avec un ingénieur Technico-commercial 
                                        qui comptabilise 18 années d’expérience dans le domaine, Un ingénieur en Qualité et 
                                        Commercial de 5 années d’expérience dans le secteur de pièces de transmission 
                                        industriel et automobiles appuyés de plusieurs commerciaux. </p>
                                    <p> Ils interviennent dans les 
                                        complexes industriels de toute la Côte d’Ivoire pour assister les industries dans le 
                                        domaine de la fourniture de pièces de transmissions industrielles et automobiles.</p>
                                </div>
                                <div class="about-carousel-box owl-carousel owl-theme">
                                    ...
                                    <div class="single-box">
                                        ...
                                        <div class="text-holder">
                                            <h3>Vision</h3>
                                            <p>Rester à l’écoute de tous besoins de son client 
                                                afin de lui faire des offres selon disponibilité au à délai.</p>
                                        </div>
                                    </div>
                                    <!--End Single Box-->
                                    <!--Start Single Box-->
                                    <div class="single-box">
                                        ...
                                        <div class="text-holder">
                                            <h3>Mission</h3>
                                            <p>I-TRANSMISSIONS emploie actuellement une dizaine de personnes et privilégie 
                                                le genre dans ses recrutements.</p>
                                        </div>
                                    </div>
                                    <!--End Single Box-->
                                    <!--Start Single Box-->
                                    <div class="single-box">
                                        ...
                                        <div class="text-holder">
                                            <h3>Valeurs</h3>
                                            <p>i-Transmission veut participer à la lutte contre le chômage en créant des emplois pour les jeunes.</p>
                                        </div>
                                    </div>
                                    <!--End Single Box-->
                                </div>
        ...
        <!--Start Working Area-->
        <section class="working-area" style="background-image:url(images/parallax-background/working-bg.png);">
            <div class="container">
                <div class="sec-title with-text max-width text-center wow fadeInDown" data-wow-delay="100ms" data-wow-duration="1200ms">
                    <p>Domaines d'applications</p>
                    <div class="title clr-white">NOS <span>SERVICES</span></div>
                    <p class="bottom-text">Dans le souci de répondre au mieux aux besoins du client, I-TRANSMISSIONS se 
                        positionne comme une centrale d’achat auprès de sa clientèle.</p>
                </div>
                <div class="row">
                        ...
                        <div class="single-working-box wow fadeInDown" data-wow-delay="0ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="outer-box">
                                    ...
                                    <div class="text">
                                        <h3>Distributions et Ventes</h3>
                                        <p>Pièces de Transmissions Industrielles et Automobiles .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-working-box wow fadeInDown" data-wow-delay="400ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="outer-box">
                                    ...
                                    <div class="text">
                                        <h3>Quincaillerie et Négoce</h3>
                                        <p>Tous vos besoins en quincaillerie industrielle et divers.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="single-working-box wow fadeInDown" data-wow-delay="800ms">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/resources/working-4.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one"></div>
                                </div>
                            </div>
                            <div class="text-holder">
        ...
        <section class="recently-project-area">
            ...
            <div class="container-fluid">
                <div class="project-carousel owl-carousel owl-theme">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            ...
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Roulements<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            ...
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Courroies<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                                <span>Trapézoïdale</span>                                
                            </div>
                        </div>
                    </div>
                    <!--End single project style1-->
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            ...
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Pâliers<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-6.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Pâlier<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-7.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Poulies<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-8.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Poulies<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-9.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Accouplements<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-10.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Accouplements<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-11.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Flector<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-12.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Flector<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-13.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Chaines<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-14.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Chaines<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-15.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Ecrous et boulons<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <!--End single project style1-->
                     ...
                     <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-16.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Ecrous et boulons<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-17.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Bagues<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-18.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Colliers<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-19.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Moteurs<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                                <span>sans patte</span>
                                <h3></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-20.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Moteurs<span class="flaticon-next"></span></a>
                    ...
                    <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-23.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="#">Electricité<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                                <span>Valise à outils</span>
                                <h3></h3>
                            </div>
                        </div>
                    </div>
                    <!--End single project style1-->
                     ...
                     <div class="single-project-style1">
                        <div class="img-holder">
                            <img src="images/projects/lat-pro-24.jpg" alt="Awesome Image">
                            <div class="overlay-content">
                                <div class="inner-content">
                                    <div class="link-box">
                                        <a class="btn-one" href="/product">Electricité<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="title-box">
                                <span>Kit d'électricité</span>
                                <h3></h3>
                            </div>
                        </div>
                    </div>
        ...
        <section class="working-process-area">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <div class="title">Notre procéssus <span>Commercial</span></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="single-working-process text-center">
                            ...
                            <div class="inner">
                                <h3>Devis</h3>
                                <p>Demande de facture proforma.</p>
                                <div class="icon-holder">
        ...
        <!--Start slogan area-->
        <section class="slogan-area pb-20">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
