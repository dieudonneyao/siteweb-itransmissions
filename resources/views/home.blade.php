                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <h3>Distribution / vente</h3>
                                    <p>I-TRANSMISSIONS est représentante et importatrice des marques.</p>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    <h3>Quincaillerie Industrielle</h3>
                                    <p>I-TRANSMISSIONS se positionne comme une centrale d’achat auprès de sa clientèle.</p>
                                </div>
                                <a class="btn-one" href="#">En savoir plus<span class="flaticon-next"></span></a>
                            </div>
                        </div>
                        ...
                        <div class="single-highlight-box text-center wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1200ms">
                            ...
                            <div class="inner-content">
                                <div class="text">
                                    ...
                                    <p>Service après-vente disponible au plus tard 10 heures
                                        après appel ou réclamation.</p>
                                </div>
                                <a class="btn-one" href="#">En savoir plus<span class="flaticon-next"></span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="about-image-box">
                            ...
                            <div class="text-box">
                                ...
                                <h3>Monsieur Adjiri, <span>CEO & Fondateur</span></h3>
                            </div>
                        </div>
                    </div>
